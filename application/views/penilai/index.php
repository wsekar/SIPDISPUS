                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        Selamat Datang di Dashboard <?php echo $_SESSION['level'] ?> <span class="fw-bold"> Sistem Penilaian Mandiri <br> Dinas Perpustakaan dan Kearsipan Kabupaten Madiun</span>
                                    </p>
                                    <hr>
                        ...
                        <div class="col-lg-2 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title text-nowrap mb-0"><?= $jumlah_jabatan ?></h3>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?= base_url('penilai/penilaian/detail/'); ?><?= $nilai['id_jabatan'] ?>"><i class="bx bx-edit-alt me-1"></i>Detail Nilai</a>
                                                        <a class="dropdown-item" onclick="deleteConfirm('<?= base_url('penilai/penilaian/hapus/' . $nilai['id_jabatan']) ?>')" data-bs-toggle="modal" data-bs-target="#deleteModal" href="#!"><i class="bx bx-trash me-1"></i> Hapus</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
