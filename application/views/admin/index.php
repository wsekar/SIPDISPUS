                        ...
                        <div class="col-lg-3 col-md-6 mb-4 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title text-nowrap mb-2"><?= $jumlah_ternilai ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-4 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title text-nowrap mb-2"><?= $jumlah_jabatan ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                        <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                            <div class="card-title">
                                                ...
                                                <a href="<?php echo base_url('assets/bukupanduan/User Manual SIPDISPUS (Admin).pdf') ?>" target=”_blank” class="btn btn-sm btn-outline-primary">Lihat</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
