        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            <form action="<?= base_url('admin/ternilai/edit/') ?><?= $users['id_u']; ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                            <form action="<?= base_url('admin/ternilai/editpass/') ?><?= $users['id_u']; ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_u" id="id_u" value="<?= $users['id_u']; ?>" />
